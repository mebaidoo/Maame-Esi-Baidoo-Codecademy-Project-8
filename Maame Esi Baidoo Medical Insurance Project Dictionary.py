...
medical_records["Valentina"] = {"Age": 52, "Sex": "Female", "BMI": 25.3, "Children": 1, "Smoker": "Non-smoker", "Insurance_cost": 6420.0}
print(medical_records)
print("Connie's insurance cost is " + str(medical_records["Connie"]["Insurance_cost"]) + " dollars.")
#Line 27 can also be written this way
...
update_medical_records("Esi", {"Age": 23, "Sex": "Female", "BMI": 18.5, "Children": 0, "Smoker": "Non-smoker", "Insurance_cost": 1000.0})
print(medical_records)